...
impl GaugeReader for GermanyBadenWuerttembergReader {
    ...
    fn list_stations<'a>(&'a self) -> BoxFuture<'a, anyhow::Result<Vec<crate::StationInfo>>> {
        Box::pin(async {
            Ok(vec![
            StationInfo { station_id: "0170".to_owned(), name: Some("Schönmünzach".to_owned()), river: Some("Schönmünz".to_owned()), latitude: Some(48.6068), longitude: Some(8.3637), params: vec!["Q".to_owned()] },
            StationInfo { station_id: "0246".to_owned(), name: Some("Forbach".to_owned()), river: Some("Murg".to_owned()), latitude: Some(48.615101), longitude: Some(8.3641), params: vec!["W".to_owned()] },
            StationInfo { station_id: "9082".to_owned(), name: Some("Zwirkenberg".to_owned()), river: Some("Obere Argen".to_owned()), latitude: Some(47.646599), longitude: Some(9.9691), params: vec!["W".to_owned()] },
            StationInfo { station_id: "0001".to_owned(), name: Some("Eberfingen".to_owned()), river: Some("Wutach".to_owned()), latitude: Some(47.720699), longitude: Some(8.4311), params: vec!["W".to_owned()] },
            StationInfo { station_id: "0004".to_owned(), name: Some("Kirchen-Hausen".to_owned()), river: Some("Donau".to_owned()), latitude: Some(47.925499), longitude: Some(8.6796), params: vec!["W".to_owned()] },
            StationInfo { station_id: "0072".to_owned(), name: Some("Ewattingen".to_owned()), river: Some("Wutach".to_owned()), latitude: Some(47.848301), longitude: Some(8.4502), params: vec!["W".to_owned()] },
            StationInfo { station_id: "0074".to_owned(), name: Some("Zell".to_owned()), river: Some("Wiese".to_owned()), latitude: Some(47.699501), longitude: Some(7.8455), params: vec!["W".to_owned()] },
            StationInfo { station_id: "0112".to_owned(), name: Some("Baden-Baden".to_owned()), river: Some("Oos".to_owned()), latitude: Some(48.7743), longitude: Some(8.2201), params: vec!["W".to_owned()] },
            StationInfo { station_id: "0114".to_owned(), name: Some("Kappelrodeck".to_owned()), river: Some("Acher".to_owned()), latitude: Some(48.5844), longitude: Some(8.1259), params: vec!["W".to_owned()] },
            StationInfo { station_id: "0170".to_owned(), name: Some("Schönmünzach (cm)".to_owned()), river: Some("Schönmünz".to_owned()), latitude: Some(48.6068), longitude: Some(8.3637), params: vec!["W".to_owned()] },
            StationInfo { station_id: "0189".to_owned(), name: Some("Simonswald".to_owned()), river: Some("Wilde Gutach".to_owned()), latitude: Some(48.111801), longitude: Some(8.0336), params: vec!["W".to_owned()] },
            StationInfo { station_id: "0206".to_owned(), name: Some("St. Blasien".to_owned()), river: Some("Hauensteiner Alb".to_owned()), latitude: Some(47.756901), longitude: Some(8.1447), params: vec!["W".to_owned()] },
            StationInfo { station_id: "0212".to_owned(), name: Some("Beutelsau".to_owned()), river: Some("Untere Argen".to_owned()), latitude: Some(47.7047), longitude: Some(9.8187), params: vec!["W".to_owned()] },
            StationInfo { station_id: "0213".to_owned(), name: Some("Gießen".to_owned()), river: Some("Argen".to_owned()), latitude: Some(47.627998), longitude: Some(9.5961), params: vec!["W".to_owned()] },
            StationInfo { station_id: "0300".to_owned(), name: Some("Gutach".to_owned()), river: Some("Elz".to_owned()), latitude: Some(48.119099), longitude: Some(7.9888), params: vec!["W".to_owned()] },
            ])
        })
    }
