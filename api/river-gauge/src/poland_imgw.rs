...
impl GaugeReader for PolandImgwReader {
    ...
    fn list_stations<'a>(&'a self) -> BoxFuture<'a, anyhow::Result<Vec<crate::StationInfo>>> {
        Box::pin(async {
            Ok(vec![
            StationInfo { station_id: "149200080".to_owned(), name: Some("Mszana Dolana".to_owned()), river: Some("Mszanka".to_owned()), latitude: Some(49.674301), longitude: Some(20.0804), params: vec!["W".to_owned()] },
            StationInfo { station_id: "149200100".to_owned(), name: Some("Lysa Polana".to_owned()), river: Some("Bialka".to_owned()), latitude: Some(49.263599), longitude: Some(20.115), params: vec!["W".to_owned()] },
            StationInfo { station_id: "149200110".to_owned(), name: Some("Trybsz 2".to_owned()), river: Some("Bialka".to_owned()), latitude: Some(49.417801), longitude: Some(20.1175), params: vec!["W".to_owned()] },
            StationInfo { station_id: "149200120".to_owned(), name: Some("Niedzica".to_owned()), river: Some("Niedziczanka".to_owned()), latitude: Some(49.411301), longitude: Some(20.302299), params: vec!["W".to_owned()] },
            StationInfo { station_id: "149200150".to_owned(), name: Some("Tylmanowa".to_owned()), river: Some("Ochotnica".to_owned()), latitude: Some(49.5172), longitude: Some(20.3869), params: vec!["W".to_owned()] },
            StationInfo { station_id: "150150030".to_owned(), name: Some("Jakuszyce".to_owned()), river: Some("Kamienna".to_owned()), latitude: Some(50.822701), longitude: Some(15.4397), params: vec!["Q".to_owned()] },
            StationInfo { station_id: "150150050".to_owned(), name: Some("Piechowice".to_owned()), river: Some("Kamiena".to_owned()), latitude: Some(50.850101), longitude: Some(15.5732), params: vec!["W".to_owned()] },
            StationInfo { station_id: "150150190".to_owned(), name: Some("Podgorzyn".to_owned()), river: Some("Podgorna".to_owned()), latitude: Some(50.820301), longitude: Some(15.6832), params: vec!["W".to_owned()] },
            StationInfo { station_id: "150160110".to_owned(), name: Some("Szalejów Dolny".to_owned()), river: Some("Bystrzyca Dusznicka".to_owned()), latitude: Some(50.419701), longitude: Some(16.6047), params: vec!["Q".to_owned()] },
            ])
        })
    }
