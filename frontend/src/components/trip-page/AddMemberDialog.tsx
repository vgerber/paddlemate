...
/**
 * Who to add. A trip is invite-only, so this is the only way in - and it is
 * an admin's to use, which is why it hangs off the members tab rather than
  ...
  return (
    ...
    >
      ...
      <PanelBottomBar
        ...
        leftLabel="Close"
        title="Add a member"
        subtitle="They see the trip as soon as you add them"
        action={null}
      />
    </Dialog>
  );
